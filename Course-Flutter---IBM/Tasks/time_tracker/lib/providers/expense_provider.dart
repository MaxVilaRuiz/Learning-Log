...
class ExpenseProvider with ChangeNotifier {
  ...
  final List<ExpenseCategory> _categories = [
    ExpenseCategory(id: '1', name: 'Project Alpha', isDefault: true),
    ExpenseCategory(id: '2', name: 'Project Beta', isDefault: true),
    ExpenseCategory(id: '3', name: 'Project Gamma', isDefault: true),
    ExpenseCategory(id: '4', name: 'Project 123', isDefault: true),
  ];
  ...
  final List<Tag> _tags = [
    ...
    Tag(id: '4', name: 'Task 1'),
    Tag(id: '5', name: 'Task 2'),
  ];
