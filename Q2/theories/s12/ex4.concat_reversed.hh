...
public:
  ...
  // Pre: cert
  // Post: S'han concatenat al final de la llista tots els seus elements,
  //       en ordre invers. La mida de la llista s'ha duplicat.
  //       Els nous nodes són còpies independents dels originals.
  void concat_copy_reversed() {
    Item* ptr = itemsup.prev; // Apunta a l'últim element real
    while (ptr != &iteminf) {
      push_back(ptr->value); // Afegeix la còpia
      ptr = ptr->prev;        // Mou cap a l'anterior
    }
  }
